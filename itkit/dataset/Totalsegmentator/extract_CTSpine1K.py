...
def parse_args():
    parser = argparse.ArgumentParser(
        description="ITK label extraction for TotalSegmentator CTSpine1K"
    )
    parser.add_argument(
        "tsd_label", type=str, help="Folder containing input label mhas"
    )
    parser.add_argument(
        "output_folder", type=str, help="Folder containing input label mhas"
    )
    parser.add_argument(
        "--mp", action="store_true", default=False, help="Use multiprocessing"
    )
