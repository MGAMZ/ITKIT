...
class MyUnet(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Sequential(
            ReparamConv(channel, filters[1], filters[0], 5, 3),
        ...
        self.transformer = BottomTransformer(
            3, 14, sum(filters), 2, filters[4], 1, 8
        )  # 多尺度GFT
        ...
        self.natt1 = NeighborhoodTransformer(
            3, 32, filters[3], filters[3], 1, [3, 5], 8
        )
        self.natt2 = NeighborhoodTransformer(
            3, 64, filters[2], filters[2], 1, [3, 5], 4
        )
        self.natt3 = NeighborhoodTransformer(
            3, 128, filters[1], filters[1], 1, [3, 5], 4
        )
        self.natt4 = NeighborhoodTransformer(
            3, 256, filters[0], filters[0], 1, [3, 5], 2
        )
